...
export default {
  ...
  methods:{
    ...
    query:function (){
      this.axios.post(this.url+'user/queryusermess', JSON.stringify({"name":window.sessionStorage.getItem('loginname')}),
      ).then(res => {//true
      ...
      this.axios.post(this.url+'user/querylog', JSON.stringify({"name":window.sessionStorage.getItem('loginname')}),
      ).then(res => {//true
        this.log = res.data[0]
